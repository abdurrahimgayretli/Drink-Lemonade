...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        val text: String
            val drawbleResource = when (lemonadeState){
            ...
            lemonImage?.setImageResource(drawbleResource)
            val textChange = when (lemonadeState){
                SELECT -> text = "Click to select a lemon!"
                SQUEEZE -> text = "Click to juice the lemon!"
                DRINK-> text = "Click to drink your lemonade!"
                RESTART -> text = "Click to start again!"
                else -> text = "Click to select a lemon!"
          }
        textAction.setText(text.toString())
